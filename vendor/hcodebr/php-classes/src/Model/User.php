...
class User extends Model {
	...
	public static function getForgot($email, $inadmin = true)
	{
		...
		else
		{
			...
			else
			{
				...
				$code = encrypt($dataRecovery["idrecovery"], $key, $method);

				if ($inadmin === true) {
					
					$link = "https://www.blueflameaquecedores.com.br/admin/forgot/reset?code=$code";

				} else {

					$link = "https://www.blueflameaquecedores.com.br/forgot/reset?code=$code";

				}
				

				$mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir Senha da Blueflame", "forgot", array(
					"name"=>$data["desperson"],
					"link"=>$link
				));
				...
				if($mailer->send()){
					...
					echo "Ocorreu um erro" . $mailer->ErrorInfo;
					exit;
				}
				*/
				...
				if($mailer->send()) {
					echo "successo";
					 ...
					 echo "There was a problem sending the form.: " . $mailer->ErrorInfo;
					 exit;
				 }
	...
	public static function validForgotDecrypt($code)
	{
		...
		$idrecovery = decrypt($code, $key, 'AES-256-CBC');
