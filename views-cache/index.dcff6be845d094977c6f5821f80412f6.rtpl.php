...
.w3-hover-black:hover {
	color: #fff!important;
	background-color: #8d150c!important
}
     ...
     <ul class="" id="bxslider-home4">
         <li>
             ...
             <div class="caption-group">
                 ...
                 <a href="/categories/2" class="btn btn-info" role="button">Comprar</a>
             </div>
             </li>
             ...
             <li><img src="/res/site/img/h4-slide3.png" alt="Slide">
                 <div class="caption-group">
                     <h2 class="caption title">
                         Apple <span class="primary">Store</span>
                     </h2>
             ...
             <li><img src="/res/site/img/h4-slide4.png" alt="Slide">
                 <div class="caption-group">
                   <h2 class="caption title">
                         Music <span class="primary">Store</span>
                     </h2>
...
<div class="w3-container">
        <div class="w3-display-container mySlides">
           <img src="/res/site/img/banner-heater-005.png" style="width:100%">
           <div class="w3-display-topleft w3-container w3-padding-32">
              <button class="w3-button w3-green w3-padding-large">Comprar</button>
              <h1 class="w3-text-white">R$1699,90</h1>
           </div>
        </div>
        <div class="w3-display-container mySlides">
           <img src="/res/site/img/banner-heater-004.png" style="width:100%">
           <div class="w3-display-topleft w3-container w3-padding-32">
              <button class="w3-button w3-green w3-padding-large">Comprar</button>
              <h1 class="w3-text-blue">R$1699,90</h1>
           </div>
        </div>
              ...
              <div class="col-md-12">
                 <div class="brand-wrapper">
                    <div class="brand-list">
						<img src="/res/site/img/brand70.png" alt="">
						<!--<img src="/res/site/img/brand20.png" alt="">-->
                       <img src="/res/site/img/brand30.png" alt="">
                       <!--<img src="/res/site/img/brand40.png" alt="">-->
                       <!--<img src="/res/site/img/brand50.png" alt="">-->
                       <img src="/res/site/img/brand60.png" alt="">
                       <img src="/res/site/img/brand10.png" alt="">
                       <!--<img src="/res/site/img/brand20.png" alt="">-->                            
                    </div>
                 </div>
              </div>
