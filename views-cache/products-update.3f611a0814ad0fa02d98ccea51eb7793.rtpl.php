...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
	    ...
	    <div class="form-group">
              <label for="detailsproduct">Detalhes do produto</label>
              <input type="text" class="form-control" id="detailsproduct" name="detailsproduct" placeholder="Digite os detalhes do produto" value="<?php echo htmlspecialchars( $product["detailsproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
            <div class="form-group">
